...
def delete_product(request, id):
    ...
    # Delete the product
    product.delete()
    # Redirect bact to the products page with a success message
...
def update_product(request, id):
    ...
    if request.method == "POST":
        ...
        # to products with a success message
        product.save()
...
def add_supplier(request):
    ...
    if request.method == "POST":
        ...
        sup_product = request.POST.get('kitu')

        # Finally save the data in our table called products
        supplier = Supplier(sup_name=sup_name, sup_email=sup_email, sup_phone=sup_phone, sup_product=sup_product)
        supplier.save()
        # Redirect back with a success message
...
def update_supplier(request, id):
    ...
    if request.method == "POST":
        ...
        updated_product = request.POST.get('kitu')
        ...
        # Return the data back to the database and redirect back
        # to supplier with a success message
        supplier.save()
...
# Generate the transaction access token
